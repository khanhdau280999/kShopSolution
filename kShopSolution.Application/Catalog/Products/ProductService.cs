...
using kShopSolution.ViewModels.Catalog.ProductImages;
...
namespace kShopSolution.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(KshopDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new KshopException($"Cannot find an image with id {imageId}");
